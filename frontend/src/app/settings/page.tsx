        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          ...
          <div className="glass-card p-6 sm:p-7 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <a
                href="https://github.com/srushti-bore/BudgetBrain.git"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-ink dark:bg-white text-white dark:text-ink text-xs font-bold hover:opacity-90 transition-opacity"
              >
