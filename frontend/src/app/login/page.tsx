    ...
    <div className="glass-card rounded-3xl p-7 sm:p-9 shadow-2xl border border-white/10 dark:border-white/5 relative z-10 backdrop-blur-xl">
      ...
      <form onSubmit={handleSubmit} autoComplete="off" className="space-y-4">
        ...
        <motion.button
          ...
          className="w-full mt-2 py-3 px-4 rounded-xl bg-sage hover:bg-sage-dark text-white font-medium text-sm flex items-center justify-center gap-2 shadow-xs hover:shadow-sm border border-white/10 dark:border-white/5 disabled:opacity-75 disabled:cursor-wait transition-all btn-subtle-shimmer"
        >
          {isRedirecting ? (
            <>
