    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        >
          ...
          <div>
            <span className="text-xs text-ink-muted font-semibold block mb-1 tracking-wider uppercase">Current Month Spend</span>
            <span className="font-display font-extrabold text-2xl md:text-3xl text-ink block">
        ...
        >
          ...
          <div>
            <span className="text-xs text-ink-muted font-semibold block mb-1 tracking-wider uppercase">Total Transactions</span>
            <span className="font-display font-extrabold text-2xl md:text-3xl text-ink block">
