...
This document logs all architectural decisions, design tradeoffs, known technical debt, and future optimization opportunities for the **BudgetBrain V1** application stack. 
